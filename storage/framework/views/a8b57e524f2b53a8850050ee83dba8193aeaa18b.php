        ...
        <div class="container">
            <div class="section-title vertical-aligned-elements">
                <div class="element text-align-right">
                    <h2 class="invisible-on-mobile pull-left featured-ads-label">Latest Projects</h2>
                    <div id="premium-nav" class="gallery-nav disabled"><div class="owl-prev"></div><div class="owl-next"></div></div>
                </div>
            </div>
            <!--end section-title-->
        </div>
        <div class="gallery featured container">
            <div class="owl-carousel owl-loaded owl-drag" data-owl-items="4" data-owl-loop="1" data-owl-auto-width="1" data-owl-nav="1" data-owl-dots="1" data-owl-nav-container="#premium-nav">
                                ...
                                <ul class="icondetail">
                                    ...
                                    <li>
                                        ...
                                        <?php if($achievement->completed == 0): ?>
                                            Ended On: Unkown
                                        <?php elseif($achievement->completed == 1): ?>
                                            Ended On: <?php echo e($achievement->ended_at->toFormattedDateString()); ?>
            ...
            <?php echo e($latestAchievements->appends(['oldest'=>$oldestAchievements->currentPage()])->links()); ?>
